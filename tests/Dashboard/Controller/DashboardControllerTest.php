...
class DashboardControllerTest extends WebTestCase
{
    ...
    public function testIndexPageDisplaysSensorDataAndCharts(): void
    {
        ...
        // For node index 0, hour 0: temp=20.00, humidity=50.25, co2=415
        static::assertStringContainsString('20.15 °C', $crawler->filter('body')->text());
        static::assertStringContainsString('50.25 %', $crawler->filter('body')->text());
        static::assertStringContainsString('415 ppm', $crawler->filter('body')->text());
    ...
    public function testIndexPageWithBedroomNode(): void
    {
        ...
        // For node index 1, hour 0: temp=20.15, humidity=50.25, co2=null
        static::assertStringContainsString('20.15 °C', $crawler->filter('body')->text());
        static::assertStringContainsString('50.25 %', $crawler->filter('body')->text());
    ...
    public function testIndexPageWithKitchenNode(): void
    {
        ...
        // For node index 2, hour 0: temp=20.15, humidity=50.25, co2=415
        static::assertStringContainsString('20.15 °C', $crawler->filter('body')->text());
        static::assertStringContainsString('50.25 %', $crawler->filter('body')->text());
        static::assertStringContainsString('415 ppm', $crawler->filter('body')->text());
    }
